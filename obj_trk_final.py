...
video = cv2.VideoCapture("C:\\Users\\dell\\Downloads\\project-C107-Project\\project-C107-template-main\\footvolleyball.mp4")
#load tracker 
...
while True:
   #Write the code inside loop here
    ...
    if success:
        ...
        cv2.putText(img,"Lost",(75,90),cv2.FONT_HERSHEY_TRIPLEX,0.7,(0,0,255),2)
